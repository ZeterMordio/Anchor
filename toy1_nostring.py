# Toy Run 1: Self-contained GRPO pipeline validation. Qwen3-1.7B + LoRA.
...
def load_products():
    ...
    for cat in CATS:
        try:
            req = urllib.request.urlopen(BASE + f"{cat}.json", timeout=15)
...
# --- Prompts ---
BUYER_SYS = (
    "You are a buyer negotiating for the lowest price.\n"
    "Format EXACTLY as:\n"
    "Thought: <reasoning>\n"
    "Talk: <what you say>\n"
